...
#            print decision, self.ht_classes[index]
...
#        features, classes = dt.load_csv(path,0)
##        num_samples = len(self.train_features)
#        learner = dt.ChallengeClassifier()
#        #print self.train_features[:num_samples].shape
#        #print len(self.train_classes[:num_samples])
#        learner.fit(features, classes)
#        output = learner.classify(features)
#        print output
#        assert cmp(output, classes) == 0
